...
/**
 * Axios instance for the VeoLMS API. The JWT is stored client-side and sent as a
 * Bearer token. In dev, baseURL '/api' is proxied to the backend (see
...
// OR a 403 asking to "login again" (a removed role / changed permissions).
// Ordinary 403s (a forbidden action) are NOT a session problem, so they're left
// alone and surface to the caller.
