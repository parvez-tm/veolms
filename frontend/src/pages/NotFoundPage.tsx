...
export function NotFoundPage() {
  return (
    <div className="relative flex min-h-[calc(100svh-4rem)] items-center justify-center overflow-hidden bg-tint px-4">
      <div className="pointer-events-none absolute -top-24 -right-16 -z-10 h-80 w-80 rounded-full bg-[#FFD9C9] opacity-60 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 left-1/4 -z-10 h-72 w-72 rounded-full bg-[#CFF4EC] opacity-60 blur-3xl" />
...
export function ForbiddenPage() {
  return (
    <div className="relative flex min-h-[calc(100svh-4rem)] items-center justify-center overflow-hidden bg-tint2 px-4">
      <div className="pointer-events-none absolute -top-24 -left-16 -z-10 h-80 w-80 rounded-full bg-[#CFF4EC] opacity-60 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 right-1/4 -z-10 h-72 w-72 rounded-full bg-[#FFD9C9] opacity-60 blur-3xl" />
